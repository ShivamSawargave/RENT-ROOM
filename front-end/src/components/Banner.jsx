...
function Banner() {
  ...
  return (
    <>
      ...
      <div className="md:my-6 md:mx-20 bg-blue-50 shadow-lg">
        <div className="text-gray-900 md:text-4xl flex justify-center items-center pt-6 pb-6">
          Benifit of SSS Rent Room
        </div>
        <div className="flex items-center justify-evenly  pb-14">
          <div className="h-20 w-20 md:text-xl">Avoid Brocker</div>
          <div className="h-20 w-20 md:text-xl">Connect directly to owner</div>
          <div className="h-20 w-20  md:text-xl">Shortlist without visit</div>
          <div className="h-20 w-20 md:text-xl">Save time and assets</div>
        </div>
      </div>

      <div className="max-w-screen-2xl container mx-6 ">
      ...
      <div className="relative isolate overflow-hidden mt-12 bg-gray-900 py-24 sm:py-32">
        <img
          alt=""
          src="https://www.nestaway.com/_next/image?url=%2Fimages%2Fnew_home_banner.png&w=1080&q=75"
          className="absolute inset-0 -z-10 h-full w-full object-contain object-right md:object-center"
        />
        <div
          aria-hidden="true"
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0">
            <h2 className="text-4xl font-bold tracking-tight text-white sm:text-6xl">A lifestyle tailor-</h2>
            <h2 className="text-4xl font-bold tracking-tight text-white sm:text-6xl">made for you</h2>

          </div>
          <div className="mx-auto mt-10 max-w-2xl lg:mx-0 lg:max-w-none">
            <div className="grid grid-cols-1 gap-x-8 gap-y-6 text-base font-semibold leading-7 text-white sm:grid-cols-2 md:flex lg:gap-x-10">
              <a href="Room"><button className="px-6 py-2 rounded-lg bg-white hover:bg-blue-800 text-black hover:text-white">Find Your Perfect Rooms -></button></a>
            </div>
      ...
      <div className=" md:flex justify-between shadow-lg md:mx-20 bg-blue-50 md:justify-around pt-12 md:mt-16">
      ...
      <div className="flex md:flex-row flex-col bg-blue-200 pb-10">
        <div><img src="https://www.nestaway.com/_next/image?url=%2Fimages%2Fnext_numbers_2.png&w=1080&q=75" alt="" /></div>
        <div>
          <div className="md:pt-24 pt-6 flex flex-wrap flex-col">
            <div className="md:pl-40 pl-20">
              <div className="text-blue-500 font-bold text-3xl">10000+</div>
              <div>Our Customers</div>
            </div>
            <div className="md:pl-40 md:pt-24 pl-20">
              <div className="text-blue-500 font-bold text-3xl">5000+</div>
              <div>ROOM across Nagpur</div>
            </div>
            <div className="md:pl-40 md:pt-24 pl-20">
              <div className="text-blue-500 font-bold text-3xl">15+</div>
              <div>Offices</div>
            </div>
          </div>
      ...
      <div className="text-gray-900 ml-6 b text-5xl flex justify-center items-center mt-12 pb-6">
        Which area you want in Nagpur
      </div>
      <div className="flex bg-blue-50 p-4 md:p-16 items-center text-gray-800 shadow-lg justify-around underline">
